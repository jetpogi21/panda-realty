...
export const GET = async (req: Request) => {
  ...
  const query = parseParams(searchParams) as Partial<EntitySearchParams>;
...
export const DELETE = async (req: Request) => {
  ...
  const body = (await req.json()) as EntityDeletePayload;
  const { deletedEntities } = body;

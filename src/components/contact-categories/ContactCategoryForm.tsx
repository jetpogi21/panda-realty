...
"use client";
import {
  ContactCategoryFormFormikInitialValues,
...
interface ContactCategoryFormProps {
  data: ContactCategoryModel | null;
  id: string;
...
const ContactCategoryForm: React.FC<ContactCategoryFormProps> = (prop) => {
  ...
  const handleFormikSubmit = (
    ...
    /*
    if (hasUpdate) {
      const additionalValidationResponse = validateContactCategory(values);
    ...
    */
    ...
    //e.g. { deletedContactCategoryTags: [], newTags: []}
  ...
  const renderFormik = (
    formik: FormikProps<ContactCategoryFormFormikInitialValues>
  ) => {
